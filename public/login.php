                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <form id="loginForm" method="post" action="" autocomplete="off">
                                    <div class="login-input-group">
                                        <input name="email" autofocus="" type="email" class="" id="email" value="help@rathe.app">
                                    </div>

                                    <div class="custom-input login-input-group">
                                        <input name="password" type="password" class="" id="password" placeholder="Password" maxlength="20">
